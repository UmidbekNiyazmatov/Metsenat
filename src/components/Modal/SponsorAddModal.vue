                ...
                <div class="bg-white rounded-xl p-0">
                    ...
                    <div class="space-y-5 py-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <div>
                                <input type="text" v-model="singleStudent.phone" placeholder="+998 XX XXX XX XX"
                                    class="p-3 border-2 bg-[#E0E7FF] w-full rounded-xl" />
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center">
                                <input v-model="singleStudent.contract"
...
watch(() => props.singleStudent.phone, (newValue) => {
    const regex = /^\+998\d{9}$/;
...
const saveData = async () => {
    try {
        console.log("Saqlash so‘rovi yuborildi:", props.singleStudent);

        const response = await client.put(`/student-update/${editedStudent.value.id}/`, editedStudent.value);
